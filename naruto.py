...
def rogue():
    jutsu =input(print("There are 100 Rogue ninja attacking, which justu will you use?  \nInput 1 chidori \nInput 2 Multi Shadow Clone Jutsu \nInput 3 Dragon Flame Jutsu \nInput 4 Run >>  "))
    if jutsu == "1":
...
def shuriken():
    trap = input(print("You stepped on a booby trap, a swarm of shuriken and kunais are launched at you, what will you do? \nInput 1 Substitution Jutsu \nInput 2 Kamehamehaaa \nInput 3 Block them with a sword \nInput 4 It's an illusion"))
    if trap == "1":
...
def forest():
    snake =input(print("You are in the forest of death and a massive 90 foot snake appears, what will you do? \nInput 1 Throw kunais and shuriken \nInput 2 Slice it up \nInput 3 Summon Gamabunta \nInput 4 Summon Gamakichi"))
    if snake == "1":
